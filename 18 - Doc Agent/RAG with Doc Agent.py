...
Requirements: ag2[openai]==0.9.9, chromadb>=0.5,<2, docling>=2.15.1,<3, llama-index, llama-index-core, llama-index-embeddings-huggingface, llama-index-llms-langchain, llama-index-llms-openai, llama-index-vector-stores-chroma, selenium>=4.28.1,<5, webdriver-manager==4.0.2
Tags: RAG, Doc Agent
