...
"""Wikepedia search Flow.

A example waldiez flow using wiki search

Requirements: ag2[openai]==0.9.5, ag2[wikipedia, openai]
Tags: wikipedia
...
# Load model API keys
# NOTE:
# This section assumes that a file named "wikepedia_search_flo_api_keys"
...
__MODELS_MODULE__ = load_api_key_module("wikepedia_search_flo")


def get_wikepedia_search_flo_model_api_key(model_name: str) -> str:
    ...
    str
        The model api key.
    """
    return __MODELS_MODULE__.get_wikepedia_search_flo_model_api_key(model_name)


# Tools

wikipedia_search = WikipediaQueryRunTool(
    language="en",
    top_k=3,
    verbose=False,
)
...
gpt_4_1_llm_config: dict[str, Any] = {
    "model": "gpt-4.1",
    "api_type": "openai",
    "api_key": get_wikepedia_search_flo_model_api_key("gpt_4_1"),
}
